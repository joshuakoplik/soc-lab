...
department: HR
label: restricted
title: Protocol for Involuntary Separation and Asset Recovery
shares: []
contains_pii: false
contains_credential: false
---

# Protocol for Involuntary Separation and Asset Recovery
...
At precisely 09:00 AM on the date of termination, the IT Security lead (currently Marcus Thorne) will execute a "Kill Switch" command across all systems. This must occur *before* the employee is notified. Revocation includes:
*   **AWS Production Environments:** Removal of all IAM roles associated with the employee’s unique ID.
*   **Proprietary Repositories:** Immediate lockout from the *Aegis-7* and *Sentinel* codebase.
*   **Communication:** Deactivation of Slack, Zoom, and corporate Gmail.

### 2. Compensation and Severance Calculation
...
*   **Hardware:** MacBook Pro (Corporate Serialized), YubiKey, and encrypted backup drives.
